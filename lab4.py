...
# модель, к-я способна контролировать сложность
...
# снижаем alpha, чтобы снизить недообучение
lasso001 = Lasso(alpha=0.01, max_iter=100000).fit(X_train, y_train) # max_iter++
